...
const Add_Project_ChefProjet = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        ...errors,
        submit: "Une erreur s'est produite lors de l'ajout du projet",
      })
    }
  }
      ...
      <main className="flex-grow">
        <div className="max-w-screen-lg mx-auto px-4 py-6">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mt-2">Ajouter un nouveau projet</h1>
...
export default Add_Project_ChefProjet
