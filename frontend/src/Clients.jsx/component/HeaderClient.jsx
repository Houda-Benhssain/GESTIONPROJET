  ...
  const loadNotifications = async () => {
    ...
    const mockNotifications = [
      ...
      },
      {
        id: 2,
        title: "Paiement reçu",
        message: "Votre paiement de 1500€ a été reçu",
        time: "1 hour ago",
        read: true,
      },
      {
        id: 3,
        title: "Nouvelle tâche terminée",
        message: "L'équipe a terminé la tâche 'Conception de la page d'accueil'",
        time: "3 hours ago",
        read: false,
      },
    ]
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center mr-4">
              <div className="text-gray-500 p-2 rounded hover:bg-gray-100">
                <Link to="/Home">
                  <img src={logo || "/placeholder.svg"} alt="PlanIt Logo" />
                </Link>
              </div>
